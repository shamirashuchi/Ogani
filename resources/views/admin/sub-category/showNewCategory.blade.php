                        ...
                        <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('sub-category.accept', ['id' => $category->id])}}" class="btn site-btn btn-sm rounded-0 text-white">
                                            Accept
                                        </a>
                                        <a href="{{route('sub-category.cancel', ['id' => $category->id])}}"  class="btn btn-danger btn-sm rounded-0">
                                            Cancel
                                        </a>
                                    </td>
                                </tr>
