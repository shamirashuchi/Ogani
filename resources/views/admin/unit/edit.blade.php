                ...
                <div class="card-body text-white">
                    ...
                    <form class="form-horizontal" action="{{route('unit.update', ['id' => $unit->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="firstName" value="{{$unit->code}}" placeholder="Unit Code" type="text" name="code"/>
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row">
                        <button class="btn bg-white text-success mx-auto col-md-4" type="submit">Update Unit Info</button>
                        </div>
                    </form>
                </div>
            </div>
