                ...
                <div class="card-body text-white">
                    ...
                    <form class="form-horizontal" action="{{route('product.update', ['id' => $product->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="sub_category_id" style="height: 40px;">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <div class="">
                                    <input class="form-control mb-3" id="" placeholder="Regular Price" type="number" name="regular_price" value="{{$product->regular_price}}"/>
