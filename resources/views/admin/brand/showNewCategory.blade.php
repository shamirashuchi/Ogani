        ...
        <div class="col-lg-10 mx-auto">
            <div class="card  mt-5 site-btn">
                <div class="card-header border-bottom mx-auto">
                    <h3 class="card-title text-white fs-1">All requested Brand Information</h3>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('brand.accept', ['id' => $category->id])}}" class="btn site-btn btn-sm rounded-0 text-white">
                                            Accept
                                        </a>
                                        <a href="{{route('brand.cancel', ['id' => $category->id])}}"  class="btn btn-danger btn-sm rounded-0">
                                            Cancel
                                        </a>
                                    </td>
                                </tr>
