                        ...
                        <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                            ...
                            @foreach($updatecategories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('brand.acceptbyadmin', ['id' => $category->id])}}" class="btn site-btn btn-sm rounded-0 text-white">
                                            Accept
                                        </a>
                                        <a href="{{route('brand.cancelbyadmin', ['id' => $category->id])}}"  class="btn btn-danger btn-sm rounded-0">
                                            Cancel
                                        </a>
                                    </td>
                                </tr>
